import { SviDocumentManager, SviLinkedFile } from '@sassoftware/vi-api/config';
...
class DocumentManagerIntegration {
   ...
   * fileName - The name of the file. This will be displayed on the attachments grid unless edited in VI. It will also be saved as the original file name.
